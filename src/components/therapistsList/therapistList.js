          ...
          <div key={therapist._id}>
            <div className="rounded overflow-hidden shadow-2xl relative">
              ...
              <p className="text-center leading-relaxed">
                In a thread on Reddit which has garnered nearly 10,000 replies,
                people who go to the gym every day (or practice some kind of
                other daily skill) have been sharing the things that help them
                stay motivated and proactive in keeping up with their good
                habits.
              </p>
