			...
			<div className="therapistfiles">
				<div className="container">
					...
					<p className="inputstyle">
						<img src={pdfimg} className="therapistfiles__pdf"></img>
						<span>cv.pdf</span>
					</p>
					<div className="therapistfiles__icon">
						<img src={downloadimg} className="therapistfiles__download"></img>
						<img src={deleteimg} className="therapistfiles__delete"></img>
					</div>
					{/* certified */}
